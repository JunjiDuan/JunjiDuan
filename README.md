...
**计算机科学本科毕业 · 人工智能方向硕士在读 · 独立开发者**

计算机科学专业本科毕业、人工智能方向硕士在读中，同时也是一名独立开发者。
致力于构建服务现实需求、经过用心设计的软件。

[我的另一面 🔭](https://JunjiDuan.github.io)
...
**当前包含：** [Infinite Reader](https://infinite-project.top/reader/) · [Infinite Voyager](https://infinite-project.top/voyager/) · Infinite Weather `设计中` 
· 更多项目即将到来
